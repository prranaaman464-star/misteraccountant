...
const billingTo = computed(() => ({
    ...
    address:
        displayInvoice.value.client?.billing_address ??
...
const dueInDays = computed(() =>
    getDaysUntilDue(displayInvoice.value.due_date),
);
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            >
                ...
                <div
                    class="pointer-events-none absolute top-0 right-0 h-32 w-48 translate-x-1/4 -translate-y-1/2 rounded-full bg-primary/5 blur-2xl"
                />

                <div class="relative p-6 sm:p-8">
                    <!-- Top section: Invoice title + Company + Status + Logo -->
                    <div
                        class="flex flex-col gap-6 border-b border-border/50 pb-6 sm:flex-row sm:items-start sm:justify-between"
                    >
                        <div>
                            <h2
                        ...
                        <div
                            class="flex flex-col items-end gap-3 sm:flex-row sm:items-start"
                        >
                            Mister Accountant
                        </div>
                    </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="space-y-2 text-sm">
                                ...
                                <div>
                                    ...
                                    <span class="font-medium">{{
                                        formatDate(displayInvoice.invoice_date)
                                    }}</span>
                                </div>
                                <div>
                                    <span class="text-muted-foreground"
                                ...
                                <div v-if="displayInvoice.is_recurring">
                                    ...
                                    <span class="font-medium">{{
                                        displayInvoice.recurring_frequency
                                    }}</span>
                                </div>
                                <div
                                    v-if="
            ...
            >
                <p class="text-sm text-muted-foreground">
                    No invoices yet. The layout above shows sample data. Create
                    an invoice to see real data here.
                </p>
                <Link
