...
<template>
    <!-- General Invoice 4 - Based on your fourth image -->
    <div class="mx-auto max-w-[900px] bg-white p-8 text-sm">
        <!-- Header -->
        <div
            class="mb-6 flex items-start justify-between border-b border-gray-200 pb-4"
        >
            <div>
        ...
        <div class="mb-6 grid grid-cols-2 gap-8">
            <div>
                ...
                <p class="text-xs text-gray-700">High Wycombe HP12 3JL</p>
        ...
        <!-- Payment Info -->
        <div class="mb-6 rounded-lg border border-gray-200 bg-purple-50 p-4">
        ...
        <div class="mb-6 flex justify-end">
            <div class="w-80 space-y-2 text-xs">
                ...
                <div v-if="data.enableTax" class="flex justify-between">
                    <span class="text-gray-600">IGST 18.0%</span>
                    <span class="font-semibold text-gray-900 tabular-nums"
                        >{{ currencySymbol
                        }}{{
